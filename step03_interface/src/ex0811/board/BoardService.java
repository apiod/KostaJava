...
public interface BoardService {
	...
	/**
	 * 수정: 글번호에해당하는 제목, 내용, 첨부파일 수정
	 * @params Board
	 * @return boolean(true 수정완료,  false 실패)
	 */
	 ...
	 * 글번호에 해당하는게시물 검색
	 * @params int -글번호
	 * @return Board -글번호에 해당하는 게시물이있으면 Board
	 * 				없으면 null;
	 */
...
*/
	 ...
	 */
	 ...
	 /**
	  * 글번호에 해당하는 번호 찾기 - 내부에서만
	  */
	 private void findByNo(int no) {
		System.out.println("findByNo call");
	 }
	 private static void findByNo1(int no) {
			System.out.println("static findByNo1 call");
		 }
}
