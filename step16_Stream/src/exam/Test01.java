...
public class Test01 {
    public static void main(String[] args) {
       ...
       double aver = students.stream().filter(s->s.getMajor().equals("Computer Science")).mapToDouble(s->s.getScore()).average().getAsDouble();
       

        System.out.println("Computer Science 전공 평균 점수: " + aver);
    }
}
