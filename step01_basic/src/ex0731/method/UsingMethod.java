...
class UsingMethodExam{
	...
	*/	
	public String methodExam03_02(String str, int a) {
		...
		System.out.println(this.methodExam03_01(a));
		return str+"바보";
	}
     ...
     (구현부에서)하는 일 : 
		...
		methodExam03_02호출
	*/	
	void methodExam03_03(int a,String str) {
		System.out.println("methodExam03_03이 호출되었습니다.");
		this.methodExam03_02(str, a);
	}
	...
	*/	
	protected double methodExam03_04(int a, double b, int c) {
		...
		return mme02.methodExam02_04(a, b, c);
...
//			ume.methodExam03_01(109); //안되는 이유는 private(클래스 외부에서 호출 못하기 때문)
			System.out.println("2: "+ ume.methodExam03_02("가나다",109));
			ume.methodExam03_03(109,"라마바");
			System.out.println("4: "+ ume.methodExam03_04(109,1.12, 100));
